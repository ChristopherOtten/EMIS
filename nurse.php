...
session_start();
	...
	if ($edit == "Y"){ 
		...
		$sql_update .= "blood_pressure='" . $bloodP . "', diagnosis='" . $diag . "' ";
		$sql_update .= "WHERE first_name='" . $first . "' AND last_name='" . $last . "' ";
		//$sql_update .= "blood_pressure='" . $bloodP . "', diagnosis='" . $diag . "', ";
		//$sql_update .="medications='" . $meds . "' WHERE first_name='" . $first . "' AND last_name='" . $last . "'  AND Nurse='" . $_SESSION['nurseName'] . "' ";
	...
	//Get last name of nurse who logged in
	...
	$_SESSION['nurseName'] = $row['lastName'];
...
<body>
	<header>
        <div class="row">
            ...
            <div class="column2">
                <?php echo "<div id=\"demo\">  </div>";
                    echo "Welcome, Nurse" ." ". $row["lastName"];?> <button onclick='myFunction()'>Logout</button>
            </div>
		...
		<ul>
			<li><a class="active"  href="nurse.php">Appointments</a></li>
...
<div class="dropdown"><form action="nurseEdit.php" method="post"> 
